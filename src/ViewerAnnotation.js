...
function ViewerAnnotation({ id, show, annotation }){
    return(
        <div id={id} 
            className={`absolute size-40 aspect-square text-white bg-krono-lime bg-opacity-[.33] p-1 rounded-tr-[25%] rounded-bl-[25%] backdrop-blur overflow-auto scrollbar-hide
            ${show ? 'block' : 'hidden'}`}>
            <div className="mx-3">
